...
// SalesFilesSection et SyncSection sont maintenant validées séparément. Remonté ici temporairement
// en attendant SettingsTabs, qui assemblera les sections avec la vraie barre d'onglets.
