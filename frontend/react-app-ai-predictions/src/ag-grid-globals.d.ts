...
declare global {
  interface Window {
    ...
    // injecte son propre CSS/DOM à la première ouverture — jamais réécrit en React ici (voir
    // commentaire en tête de ce fichier JS), car aussi utilisé par purchase-order.html.
