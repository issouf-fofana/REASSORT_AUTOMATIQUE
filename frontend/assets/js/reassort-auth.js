...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (user && user.role === 'ADMIN') {
      ...
      ['settings-menu-heading', 'settings-menu-reassort', 'settings-menu-files', 'settings-menu-rpos', 'settings-menu-cron', 'settings-menu-sync', 'settings-menu-ai', 'menu-item-ai-improvements', 'menu-item-ai-corrections', 'menu-item-ai-mastery', 'menu-item-ai-autonomy', 'menu-item-order-anomalies', 'menu-item-audit-errors', 'menu-item-error-log'].forEach(function (id) {
